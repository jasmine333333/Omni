...
hello_world::module::Fric::Config kFricConfig = {
    ...
    .spd_stop_thre = 5.0f,
    .resurrection_duration = 500,
    .opt_spd_same_pid_enabled = false,
   .opt_blt_spd_cl = {
        .is_enabled = true,
        .min_reasonable_blt_spd = 21.0f,
        .max_reasonable_blt_spd = 27.0f,
        .min_target_blt_spd = 23.5f,
        .max_target_blt_spd = 24.5f,
        .spd_gradient = 5.0f
    }    
};
